...
/**
 * The HL7 payload a snippet puts on the wire: the string literal handed to the first
 * `Buffer.from("...")`, decoded by the JSON string grammar, which is the JavaScript one for every
